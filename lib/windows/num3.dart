...
import 'package:FlutPR1/colors.dart';
        ...
        children: [
              ...
              Container(
                decoration: BoxDecoration(
                    ...
                    image: const DecorationImage(
                      image: AssetImage("assets/pck5.png"),
                      fit: BoxFit.cover,
                    ),
                ...
                child: Row(
                  children: [
                    Stack(
                      children: [
                        ClipRRect(
                          child: Image.asset("assets/pck6.png"),
                        ),
                        Padding(
                          padding: EdgeInsets.only(top: 45, left: 17),
                          child: Row(children: [
                            Image.asset("assets/pck7.png"),
                            SizedBox(width: 110),
                            Text(
                              'Invite your\nfriends to join',
                              style: TextStyle(
                            ...
                            SizedBox(width: 30),
                            Image.asset("assets/icon/icn3.png")
                          ]),
                        ),
                      ],
                    ),
          ...
          Positioned(
            ...
            child: Row(children: <Widget>[
              Image.asset(
                "assets/icon/icn6.png",
              ),
              Image.asset(
                "assets/icon/icn7.png",
              ),
              Image.asset(
                "assets/icon/icn8.png",
              ),
              Image.asset(
                "assets/icon/icn9.png",
              ),
              Container(
                width: 40,
                height: 40,
          ...
          Positioned(
            top: 860,
            left: 110,
            child: Image.asset("assets/pck8.png"),
          ),
          Positioned(
              top: 300,
              child: Column(
